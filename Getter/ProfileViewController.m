...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"follower"]) {
        ...
        fafViewController.username = username;
        fafViewController.authFaF = auth;
        ...
        FavlistViewController *favlistViewController = (FavlistViewController*)[segue destinationViewController];
        favlistViewController.favlistFav = favlistPro;
    }
}
